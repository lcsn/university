...
public class MotorJoystickControllerGuiView extends JFrame {

	private static final long serialVersionUID = 4472345034422982777L;

	private int displayWidth = 340;
	private int displayHeight = 550;
	private final Point position;

	public MotorJoystickControllerGuiView() {
	...
	public static void main(final String[] args) {
		Runnable gui = new Runnable() {
			@Override
			public void run() {
				new MotorJoystickControllerGuiView().setVisible(true);
			}
		};
...
class SimpleJoystick extends JPanel {
	...
	private Stroke lineStroke = new BasicStroke(5, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
	private final Point position;
	...
	protected void paintComponent(final Graphics g) {
		...
		textHorizPos = 50;
		textVertPos += 12;
		g2.drawString("MouseX :", textHorizPos, textVertPos);
		textHorizPos += (4 * fontSpace);
		g2.drawString(String.valueOf(mouseX), textHorizPos, textVertPos);
		textHorizPos = 50;
		textVertPos += 12;
		g2.drawString("MouseY :", textHorizPos, textVertPos);
		textHorizPos += (4 * fontSpace);
		g2.drawString(String.valueOf(mouseY), textHorizPos, textVertPos);
	}
